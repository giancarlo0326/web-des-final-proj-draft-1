document.addEventListener("DOMContentLoaded", function() {
    ...
    function clearCart() {
        ...
        updateTotalAmount();
        toggleProceedButton(); // Update proceed button state after clearing cart
    }
    ...
    function loadCartItems() {
        ...
        if (savedItems) {
            ...
            updateTotalAmount();
            toggleProceedButton(); // Update proceed button state after loading cart items
        }
    }
    ...
    toggleProceedButton(); // Call the function initially
    ...
    cartItemsWrapper.addEventListener('click', function(event) {
        if (event.target.classList.contains('remove-from-cart')) {
            ...
            updateTotalAmount();
            saveCartItems();
            toggleProceedButton(); // Update proceed button state after removing item
        }
    });
